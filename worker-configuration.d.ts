/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17afcd3ef56e6b19d5c354d43d169bfe)
// Runtime types generated with workerd@1.20260409.1 2024-01-01 
export {};
declare global {
	const IMAGES: R2Bucket;
	const DB: D1Database;
	const R2_PUBLIC_URL: "https://pub-cea976465d874925ae7c600b260729bd.r2.dev";
	const ADMIN_TOKEN: "64a8f4551449eeabee4756674975375dca96b169c371e4e3a94d1f67406f511b";
	const CLOUDFLARE_ACCOUNT_ID: string;
	const CLOUDFLARE_R2_ACCESS_KEY_ID: string;
	const CLOUDFLARE_R2_SECRET_ACCESS_KEY: string;
	const CLOUDFLARE_R2_BUCKET_NAME: string;
	const CLOUDFLARE_R2_PUBLIC_URL: string;
